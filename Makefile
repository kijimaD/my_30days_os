...
$(BOOTPACK_BIN): $(BOOTPACK_SRC) $(ASM_LIB_BIN) $(FONT_BIN) sprintf.c
	...
	gcc -nostdlib -m32 -fno-pic -c -o bin/sprintf.o sprintf.c
	ld -m elf_i386 -o $@ -T $(BOOTPACK_LINK_SCRIPT) -e HariMain --oformat=binary bin/bootpack.o $(ASM_LIB_BIN) $(FONT_BIN) bin/sprintf.o
